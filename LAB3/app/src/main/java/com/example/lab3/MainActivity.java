...
public class MainActivity extends AppCompatActivity implements OnChangeListener, View.OnClickListener {
    ...
    private void fillData() {
        arr_goods.add(new Good(1, "Product iphone 14 PRO", 10.0, R.drawable.a, false));
        arr_goods.add(new Good(2, "Product iphone 15 PRO", 15.0, R.drawable.b, false));
        arr_goods.add(new Good(3, "Product iPhone 14", 20.0, R.drawable.c, false));
        arr_goods.add(new Good(4, "Product iPhone 13 PRO", 12.0, R.drawable.d, false));
    }
