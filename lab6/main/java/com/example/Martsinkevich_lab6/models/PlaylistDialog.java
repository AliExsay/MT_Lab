package com.example.Martsinkevich_lab6.models;
...
import com.example.Martsinkevich_lab6.activities.VideoFilesActivity;
...
public class PlaylistDialog extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences(VideoFilesActivity.MY_PREF, Context.MODE_PRIVATE);
