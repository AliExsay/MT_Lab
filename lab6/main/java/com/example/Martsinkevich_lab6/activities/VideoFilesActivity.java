package com.example.Martsinkevich_lab6.activities;
...
import com.example.Martsinkevich_lab6.adapters.VideoFilesAdapter;
import com.example.Martsinkevich_lab6.models.MediaFiles;
...
public class VideoFilesActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private ArrayList<MediaFiles> fetchMedia(String folderName) {
        ...
        String[] selectionArg1 = new String[]{"%"+folderName+"%"};
        Cursor cursor1 = getContentResolver().query(uri1, null,
                selection1, selectionArg1, sortOrder);
        if (cursor1 != null && cursor1.moveToNext()) {
            do {
                @SuppressLint("Range") String id = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media._ID));
                @SuppressLint("Range") String title = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.TITLE));
                @SuppressLint("Range") String displayName = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.DISPLAY_NAME));
                @SuppressLint("Range") String size = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.SIZE));
                @SuppressLint("Range") String duration = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.DURATION));
                @SuppressLint("Range") String path = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.DATA));
                @SuppressLint("Range") String dateAdded = cursor1.getString(cursor1.getColumnIndex(MediaStore.Video.Media.DATE_ADDED));
        ...
        String selection2 = MediaStore.Images.Media.DATA+" like?";
        String[] selectionArg2 = new String[]{"%"+folderName+"%"};
        Cursor cursor2 = getContentResolver().query(uri2, null,
                selection2, selectionArg2, sortOrder);
        if (cursor2 != null && cursor2.moveToNext()) {
            do {
                @SuppressLint("Range") String id = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media._ID));
                @SuppressLint("Range") String title = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.TITLE));
                @SuppressLint("Range") String displayName = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.DISPLAY_NAME));
                @SuppressLint("Range") String size = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.SIZE));
                @SuppressLint("Range") String duration = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.SIZE));
                @SuppressLint("Range") String path = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.DATA));
                @SuppressLint("Range") String dateAdded = cursor2.getString(cursor2.getColumnIndex(MediaStore.Images.Media.DATE_ADDED));
