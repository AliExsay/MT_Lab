...
public class MainActivity extends AppCompatActivity {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                bluetoothButton.setVisibility(View.VISIBLE); // Показываем кнопку отправки по Bluetooth
                            }
                        });
    ...
    private void deleteJournal() {
        if (downloadedFile != null && downloadedFile.exists()) {
            if (downloadedFile.delete()) {
                ...
                bluetoothButton.setVisibility(View.GONE); // Скрываем кнопку отправки по Bluetooth после удаления файла
            } else {
    ...
    private void sendFileOverBluetooth() {
        if (downloadedFile != null && downloadedFile.exists()) {
            ...
            Intent chooser = Intent.createChooser(intent, "Отправить файл");
    ...
    public File getDownloadDirectory(Context context) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            // Путь к каталогу приложения для хранения файлов
            downloadDir = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "Научный вестник");
        } else {
