...
public class MainActivity extends FragmentActivity {
    ...
    public void DelButtonClick(View view) {
        final ArrayList<Integer>[] ids = new ArrayList[]{getAllId()};
            ...
            builder.setMessage("Вы уверены, что хотите удалить элемент?")
                    .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (ids[0].size() > 0) {
                                IDtextview.setText(String.valueOf(ids[0].get(0)));
                            } else {
                                IDtextview.setText("...");
                                ID2textview.setText("...");
                            }
                            Toast toast = Toast.makeText(MainActivity.this, "Элемент удалён!", Toast.LENGTH_SHORT);
                            toast.show();

                            listAdapter = new MyListAdapter(MainActivity.this, getAllId(), getData());
                            listView.setAdapter(listAdapter);
