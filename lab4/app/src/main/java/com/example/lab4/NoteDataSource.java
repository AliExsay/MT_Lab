...
public class NoteDataSource {
    ...
    public void deleteNote(long noteId) {
        database.delete("notes", "_id = " + noteId, null);
    }

    public void updateNote(long noteId, String newDescription) {
        ContentValues values = new ContentValues();
        values.put("description", newDescription);
        database.update("notes", values, "_id = " + noteId, null);
    }
    ...
    public Cursor getNoteById(long noteId) {
        ...
        return database.query("notes", columns, selection, selectionArgs, null, null, null);
    }
