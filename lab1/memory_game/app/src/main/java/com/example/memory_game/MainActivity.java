...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int boardSize = Integer.parseInt(settings.getString("key_board_size", "4"));

        GridView view = (GridView) findViewById(R.id.field);
        view.setNumColumns(boardSize);
        ...
        mAdapter = new GridAdapter(this, boardSize, boardSize, PictureCollection);
